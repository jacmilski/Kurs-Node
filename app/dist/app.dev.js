...
var _require = require('./config'),
    secretSessionKey = _require.secretSessionKey;

var helmet = require('helmet'); // init database


require('./db/mongoose'); // session middleware
...
app.set('views', path.join(__dirname, '/../views')); // set layout

app.use(expressLayouts);
app.set('layout', 'layouts/main'); // public folder
...
app.use('/', express.urlencoded({
  extended: true
})); // odbiera dane z formularza i zapisuje do body
